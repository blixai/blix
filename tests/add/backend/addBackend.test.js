...
const {testBackend} = require('../../add/addBackendTests')
const {addMongooseToScripts} = require('../../add/addMongoDB')
const {addBookshelfToScripts} = require('../../add/addBookshelf')
const addProjectInstructions = require('../../add/addProjectInstructions')
const helpers = require('../../helpers')
const fs = require('fs')
const store = require('../../new/store')
const backend = require('../../add/addBackend')
const {
  createBackend,
  standard,
  mvcType,
...
jest.mock('../../add/addBackendTests')
jest.mock('../../add/addMongoDB')
jest.mock('../../add/addBookshelf')
