...
let railsApp = test => {
  ...
  helpers.writeFile(`./${name}/scripts/page.js`, enzoNewPage);
  helpers.writeFile(
    `./${name}/scripts/templates/htmlPageTemplate.html`,
    htmlPageTemplate
  );
...
let pugApp = test => {
  ...
  fs.mkdirSync(`./${name}/scripts`);
  fs.mkdirSync(`./${name}/scripts/templates`);
  helpers.writeFile(`./${name}/scripts/page.js`, enzoPugPage);
  helpers.writeFile(`./${name}/scripts/templates/pugTemplate.pug`, pugTemplate);
  helpers.writeFile(`./${name}/scripts/api.js`, enzoAPI);
  helpers.writeFile(
    `./${name}/scripts/templates/enzoEndpointTemplate.js`,
    enzoEndpointTemplate
