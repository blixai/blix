...
let createReactSPA = () => {
  rl.question('Do you need a backend? (Y/N) ', (backend) => {
    ...
    if (backend === 'y') {
      ...
      installDevDependencies('webpack webpack-dev-server babel-loader css-loader babel-core babel-preset-env babel-preset-react style-loader webpack-merge uglifyjs-webpack-plugin sass-loader node-sass extract-text-webpack-plugin')
      process.stdout.write('\033c')
      log('The project was created!')
...
let createReactRedux = () => {
  rl.question('Do you need a backend? (Y/N) ', (backend) => {
    ...
    if (backend === 'y') {
      ...
      installDevDependencies('webpack webpack-dev-server babel-loader css-loader babel-core babel-preset-env babel-preset-react style-loader webpack-merge uglifyjs-webpack-plugin sass-loader node-sass extract-text-webpack-plugin clean-webpack-plugin')
      process.stdout.write('\033c')
      log('The project was created!')
      log(`cd into ${name}`)
      log(`First start webpack: npm run build`)
        ...
        if (answer === 'y') {
            ...
            if (database === 'p') {
              ...
              rl.question('Do you want to use the templating engine Pug? (Y/N) ', (answer) => {
                ...
                if (answer === 'y') {
                  ...
                  shell.cd(`${name}`)
                  log('Downloading dependencies and setting up the project, this may take a moment')
                  install('express nodemon pg knex body-parser compression helmet dotenv bookshelf pug morgan')
                  ...
                  shell.cd(`${name}`)
                  log('Downloading dependencies and setting up the project, this may take a moment')
                  install('express nodemon pg knex body-parser compression helmet dotenv bookshelf morgan')
              ...
              rl.question('Do you want to use the templating engine Pug? (Y/N) ', (answer) => {
                ...
                if (answer === 'y') {
                  ...
                  shell.cd(`${name}`)
                  log('Downloading dependencies and setting up the project, this may take a moment')
                  install('express nodemon mongo body-parser compression helmet dotenv mongoose pug morgan')
                  installDevDependencies('webpack babel-loader css-loader babel-core babel-preset-env style-loader webpack-merge uglifyjs-webpack-plugin sass-loader node-sass extract-text-webpack-plugin clean-webpack-plugin')
                  process.stdout.write('\033c')
                  log('The project was created!')
                  log(`cd into ${name} and run npm start`)
                  ...
                  shell.cd(`${name}`)
                  log('Downloading dependencies and setting up the project, this may take a moment')
                  install('express nodemon mongo body-parser compression helmet dotenv mongoose morgan')
                  installDevDependencies('babel-core babel-preset-env babelify gulp gulp-uglify gulp-rename browserify gulp-htmlmin gulp-clean-css gulp-tap gulp-buffer del run-sequence envify bundle-collapser gulp-plumber gulp-sass')
                  process.stdout.write('\033c')
                  log('The project was created!')
                  log(`cd into ${name} and run npm start`)
          ...
          rl.question('Do you want to use the templating engine Pug? (Y/N) ', (answer) => {
            ...
            if (answer === 'y') {
              ...
              shell.cd(`${name}`)
              log('Downloading dependencies and setting up the project, this may take a moment')
              install('express nodemon body-parser compression helmet dotenv pug morgan')
              installDevDependencies('webpack babel-loader css-loader babel-core babel-preset-env style-loader webpack-merge uglifyjs-webpack-plugin sass-loader node-sass extract-text-webpack-plugin clean-webpack-plugin')
              process.stdout.write('\033c')
              log('The project was created!')
              log(`cd into ${name} and run npm start`)
              ...
              shell.cd(`${name}`)
              log('Downloading dependencies and setting up the project, this may take a moment')
              install('express nodemon body-parser compression helmet dotenv morgan')
              installDevDependencies('babel-core babel-preset-env babelify gulp gulp-uglify gulp-rename browserify gulp-htmlmin gulp-clean-css gulp-tap gulp-buffer del run-sequence envify bundle-collapser gulp-plumber gulp-sass')
              process.stdout.write('\033c')
              log('The project was created!')
              log(`cd into ${name} and run npm start`)
