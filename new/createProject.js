        ...
        if (database === 'y') {
          rl.question('Postgres or MongoDB? (P/M) ', (type) => {
            ...
            if (type === 'p') {
              ...
              installDevDependencies('babel-loader css-loader babel-core babel-preset-env babel-preset-react style-loader webpack-merge uglifyjs-webpack-plugin')
        ...
        if (answer === 'y') {
          rl.question('Postgres or MongoDB? (P/M) ', (database) => {
            ...
            if (database === 'p') {
              ...
              installDevDependencies('babel-core babel-preset-env babelify browserify gulp gulp-babel gulp-rename gulp-uglify vinyl-buffer vinyl-source-stream gulp-htmlmin gulp-clean-css')
              installKnexGlobal()
              modifyKnex()
              try {
                execSync(`createdb ${name};`, { stdio: 'ignore' });
