...
let spaNoSQLPck = `{\n\t"name": "${name}",\n\t"version": "1.0.0",\n\t"scripts": {\n\t\t"start": "nodemon server/cluster.js",\n\t\t"build": "webpack --watch",\n\t\t"redux": "node scripts/createComponentAndContainer.js",\n\t\t"api": "node scripts/enzoCreateAPI.js",\n\t\t"prod": "webpack --config webpack.prod.js",\n\t\t"action": "node scripts/action.js"\n\t}\n}`;
...
let ReactReduxWithBackend = () => {
  ...
  helpers.writeFile(
    `./${name}/src/containers/App/AppContainer.js`,
    appContainer
  );
  ...
  helpers.writeFile(
    `./${name}/scripts/createComponentAndContainer.js`,
    enzoCreateContainer
  );
  helpers.writeFile(
  ...
  helpers.writeFile(
    `./${name}/scripts/templates/enzoDumbComponentTemplate.js`,
  ...
  // create API
  helpers.writeFile(`./${name}/scripts/enzoCreateAPI.js`, enzoCreateAPI);
  helpers.writeFile(
    `./${name}/scripts/templates/enzoEndpointTemplate.js`,
    enzoEndpointTemplate
  );
  helpers.writeFile(
    `./${name}/scripts/templates/enzoControllerTemplate.js`,
